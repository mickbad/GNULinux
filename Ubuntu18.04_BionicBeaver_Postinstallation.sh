...
echo "[14] Viber (logiciel de communication, surtout connue en application mobile)"
echo "[14] Telegram (appli de messagerie basée sur le cloud avec du chiffrage)"
echo "[15] Wire (un autre client de messagerie instantanée chiffré crée par Wire Swiss)"
echo "[16] Hexchat (client IRC, fork de xchat)"
...
echo "[2] VLC (le couteau suisse de la vidéo, très complet !)"
...
echo "[5] Glances"
echo "[6] Brasero (logiciel de gravure de cd/dvd)" #===> vérifier si installé par défaut ou pas
